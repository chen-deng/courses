...
int
_minifyjpeg_1 (Img  *argp, void *result, struct svc_req *rqstp)
{
	return (minifyjpeg_1_svc(*argp, result, rqstp));
}
...
{
	union {
		Img minifyjpeg_1_arg;
	} argument;
	union {
		Img minifyjpeg_1_res;
	} result;
	bool_t retval;
	...
	case MINIFYJPEG:
		...
		local = (bool_t (*) (char *, void *,  struct svc_req *))_minifyjpeg_1;
		break;
